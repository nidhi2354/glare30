          ...
          <div className="relative flex flex-col items-start gap-8 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-xl">
              ...
              <h2 className="mt-5 text-2xl leading-tight font-bold text-white sm:text-3xl lg:text-4xl">
                Seats for the new session are <span className="text-gradient-gold">filling up fast</span>
              </h2>
              <p className="mt-4 text-sm leading-relaxed text-navy-200 sm:text-base">
                Book a free demo class for your child and see for yourself how learning happens at Glare30.
              </p>
            </div>
